...
namespace BTL_Web_Cinema.Areas.Admin.Controllers
{
    public class VesController : BaseController
    {
        ...
        {
            var ves = db.Ves.Include(v => v.LichChieu).Include(v => v.User);
        ...
        {
            ViewBag.MaSuatChieu = new SelectList(db.LichChieux, "MaSuatChieu", "MaSuatChieu");         
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "MaVe,MaSuatChieu,UserName,SoGhe")] Ve ve)
        {
            ...
            ViewBag.UserName = new SelectList(db.Users, "UserName", "Password", ve.UserName);
            return View(ve);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaVe,MaSuatChieu,UserName,SoGhe")] Ve ve)
        {
            if (ModelState.IsValid)
            {
